...
// Standalone page version for registration
...
export default function RegisterPage() {
    ...
    return (
        <div className={cx('page-container')}>
            <div className={cx('page-box')}>
                <div className={cx('page-header')}>
                    <h2 className={cx('page-title')}>Đăng ký</h2>
                    <Button
                        className={cx('page-close')}
                        onClick={() => navigate(-1)}
                        aria-label="Đóng"
                    >
                        ×
                ...
                {step === 1 ? (
                    <form onSubmit={handleSendEmail}>
                        <div className={cx('page-group')}>
                            <label className={cx('page-label')}>Địa chỉ Email</label>
                            <input
                                type="text"
                                value={email}
                        ...
                        {error && (<div className={cx('page-error')}>{error}</div>)}
                        <Button
                            type="submit"
                            className={cx('page-submit', 'page-submit--outline')}
                            disabled={isLoading}
                        >
                    ...
                    <form onSubmit={verifyOtp}>
                        <p className={cx('helper-text')}>Nhập mã gồm 6 chữ số đã được gửi tới {email}</p>
                    ...
                    <form onSubmit={handleSubmit}>
                        <div className={cx('page-group')}>
                            <label className={cx('page-label')}>Tên đăng nhập</label>
                            <input
                                value={username}
                        ...
                        <div className={cx('page-group')}>
                            <label className={cx('page-label')}>Mật khẩu</label>
                            <div className={cx('page-fieldWrap')}>
                                <input
                                ...
                                <Button
                                    ...
                                    className={cx('page-eye')}
                                >
                                    <img src={show1 ? invisibleIcon : visibleIcon} alt={show1 ? 'Ẩn' : 'Hiện'} className={cx('icon')} />
                                </Button>
                            </div>
                        </div>
                        <div className={cx('page-group')}>
                            <label className={cx('page-label')}>Xác nhận mật khẩu</label>
                            <div className={cx('page-fieldWrap')}>
                                <input
                                ...
                                <Button
                                    ...
                                    className={cx('page-eye')}
                                >
                                    <img src={show2 ? invisibleIcon : visibleIcon} alt={show2 ? 'Ẩn' : 'Hiện'} className={cx('icon')} />
                                </Button>
                            </div>
                        </div>
                        <div className={cx('page-agreeRow')}>
                            <label className={cx('page-agreeLabel')}>
                                <input
                                    type="checkbox"
                                    checked={agree}
